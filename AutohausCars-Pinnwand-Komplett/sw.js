const CACHE = 'carsautohaus-betriebszentrale-v17-pinboard';
const ASSETS = ['./', './index.html', './premium-ui.css?v=14', './palette-lock.css?v=14', './vehicle-analysis.css?v=16', './vehicle-analysis.mjs?v=16', './supabase/functions/_shared/vehicle-export.mjs?v=15', './supabase/functions/_shared/analysis-contract.mjs?v=15', './app.js?v=17', './voice-assistant.js', './free-dictation.js', './listing-paste-import.js', './operations-suite.js?v=14', './comparison-pro.js?v=17', './pinboard.js?v=17', './pinboard.css?v=17', './config.js', './manifest.webmanifest', './icon.svg'];
