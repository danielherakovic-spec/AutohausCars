const CACHE = 'carsautohaus-betriebszentrale-v18-shared-pinboard';
const ASSETS = ['./', './index.html', './premium-ui.css?v=14', './palette-lock.css?v=14', './vehicle-analysis.css?v=16', './vehicle-analysis.mjs?v=16', './supabase/functions/_shared/vehicle-export.mjs?v=15', './supabase/functions/_shared/analysis-contract.mjs?v=15', './app.js?v=18', './voice-assistant.js', './free-dictation.js', './listing-paste-import.js', './operations-suite.js?v=14', './comparison-pro.js?v=17', './pinboard.js?v=18', './pinboard-sync.js?v=18', './pinboard-calculator.js?v=18', './pinboard.css?v=18', './config.js', './manifest.webmanifest', './icon.svg'];
